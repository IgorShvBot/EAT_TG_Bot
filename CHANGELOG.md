...
## [v3.11.0] - 2025-07-07
### Добавлено
- Команда `/edit_tamlates`: Добавить параметр для подстановки данных из БД и управление шаблонами редактирования

### Изменено
- Команда `/edit`: Добавить текст пользователя в кнопки фильтров (edit.py)
- Команда `/edit`: Добавить параметр (ID записи) для подстановки данных из БД
