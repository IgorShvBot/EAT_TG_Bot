...
- добавить автотесты
- Выводить в подписи к итоговому файлу Result количество записей, операций (счетчик), которые в нём содержатся
- Добавить поле "pdf_type" в команду /edit для возможности редактировать данное поле через бота
